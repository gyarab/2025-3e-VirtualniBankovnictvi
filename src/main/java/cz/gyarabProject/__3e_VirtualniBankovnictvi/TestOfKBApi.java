...
public class TestOfKBApi {
     ...
     */
    @GetMapping(value = "/test-of-kb-api/newJWT")
     ...
     */
    @GetMapping(value = "/test-of-kb-api/registration")
    ...
    @GetMapping(value = "test-of-kb-api/token", produces = MediaType.TEXT_HTML_VALUE)
